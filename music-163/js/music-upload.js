    ...
    let controller = {
        ...
        initQiniu() {
            var uploader = Qiniu.uploader({
                ...
                domain: 'pdg4shigl.bkt.clouddn.com', // bucket 域名，下载资源时用到，如：'http://xxx.bkt.clouddn.com/' **必需**
                ...
                init: {
                    ...
                    'UploadProgress': function(up, file) {
                        // 每个文件上传时,处理相关的事情
                        uploadStatues.textContent = '上传ing'
                    },
                    'FileUploaded': function(up, file, info) {
                        uploadStatues.textContent = 'Ojbk'
                            // 每个文件上传成功后,处理相关的事情
                        ...
                        var songArray = response.key.split('-')
                        var name = songArray[0]
